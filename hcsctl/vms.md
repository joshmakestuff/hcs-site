...
hcsctl boots a Gen2/UEFI VHDX as an HCS compute system. You supply the image; hcsctl
...
image; it answers over a Hyper-V socket, so it works without a NIC or DHCP lease.
